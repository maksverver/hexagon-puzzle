// Brute force solution for a hexagon of size 4 (diameter 5).
...
bool valid(int row, int col) {
  return abs(row - 2) <= 2 && abs(col - 2) <= 2 && abs((row - 2) - (col - 2)) <= 2;
}

bool centre(int row, int col) { return row == 2 && col == 2; }
